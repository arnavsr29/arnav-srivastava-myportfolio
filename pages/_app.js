...
export default function App({ Component, pageProps }) {
	...
	const title = "Portfolio | Arnav Srivastava";
	const description =
		"Hello! I'm Arnav Srivastava, a passionate data analyst and problem solver. Welcome to my portfolio";
	const avatar =
	"https://res.cloudinary.com/dyle3hnpw/image/upload/v1696091629/portfolio/WhatsApp_Image_2023-09-30_at_10.02.55_PM_jk44v9.jpg";
	 const url = "https://arnav-srivastava-myportfolio.vercel.app/";
